$(document).ready(function(){
                ...
                }).on("loaded.rs.jquery.bootgrid", function()
                {
                    ...
                    {
                        window.location.href = "/admin/tags" + $(this).data("row-id") + "/modifica";
                    ...
                    }).end().find(".command-delete").on("click", function(e)
                    {
                            ...
                            rows[0] = id;
                                ...
                                swal({   
                                    title: "Sei sicuro di voler cancellare questo Tag?",   
                                    ...
                                    swal("Cancellato!", "Il Tga e stato cancellato con successo.", "success"); 
                                    deleteResource(id, 'tags');
