                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h2>Statistiche Visite <small>Vestibulum purus quam scelerisque, mollis nonummy metus</small></h2>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div id="best-selling" class="dash-widget-item">
                                    <div class="dash-widget-header">
                                        ...
                                        <img src="/adm/img/widgets/alpha.jpg" alt="">
                                        <div class="main-item">
                                    ...
                                    <div class="listview p-t-5">
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="/adm/img/widgets/note4.jpg" alt="">
                                                </div>
                                        ...
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="/adm/img/widgets/mate7.jpg" alt="">
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="/adm/img/widgets/535.jpg" alt="">
                                                </div>
                                                <div class="media-body">
                                ...
                                <div class="card-body">
                                    <div class="listview">
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="/adm/img/profile-pics/1.jpg" alt="">
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="/adm/img/profile-pics/2.jpg" alt="">
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="/adm/img/profile-pics/3.jpg" alt="">
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="/adm/img/profile-pics/4.jpg" alt="">
                                                </div>
                                                <div class="media-body">
